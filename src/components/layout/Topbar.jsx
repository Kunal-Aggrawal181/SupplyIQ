      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        {savedActions.length > 0 && (
          <div style={{
            ...
            background: 'rgba(245,158,11,0.10)', padding: '5px 12px',
            borderRadius: 20, border: '1px solid rgba(245,158,11,0.25)',
            cursor: 'pointer',
          }}
            onClick={() => showToast(`${savedActions.length} actions pending API sync. Connect backend to flush.`, 'warning')}
          >
            ⏳ {savedActions.length} pending sync
          </div>
        )}
